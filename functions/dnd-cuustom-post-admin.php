...
function dnd_character_choose_radio_callback( $post ) {
  ...
  // Add an nonce field so we can check for it later and beef up its security
  ...
  */
  ...
  $classvalue = get_post_meta( $post->ID, 'main-class', true ); // the meta_key
  ?> 

	<!-- Add our radio button choices to choose character -->
...
<div class="meta-options char_field_fields races dnd-checkbox">
  <label for="main-race"><?php _e( "Choose your race:", 'inmyculture' ); ?></label>
    <div class="char_checkbox_box">
        ...
        <label for="dndrace2"><img src="<?php echo plugins_url('images/dnd-race-dwarf-min.png', dirname(__FILE__)); ?>"><span>Dwarf</span></label>
        ...
        <label for="dndrace4"><img src="<?php echo plugins_url('images/dnd-race-elf-min.png', dirname(__FILE__)); ?>"><span>Elf</span></label>
        
        <input id="dndrace5" type="radio" name="race_class_buttons" value="Gnome" <?php checked( $racevalue, 'Gnome' ); ?>>
        <label for="dndrace5"><img src="<?php echo plugins_url('images/256x256.png', dirname(__FILE__)); ?>"><span>Gnome</span></label>
        
        <input id="dndrace6" type="radio" name="race_class_buttons" value="Half-elf" <?php checked( $racevalue, 'Half-elf' ); ?>>
        <label for="dndrace6"><img src="<?php echo plugins_url('images/256x256.png', dirname(__FILE__)); ?>"><span>Half-elf</span></label>
        
        <input id="dndrace7" type="radio" name="race_class_buttons" value="Half-orc" <?php checked( $racevalue, 'Half-orc' ); ?>>
        <label for="dndrace7"><img src="<?php echo plugins_url('images/256x256.png', dirname(__FILE__)); ?>"><span>Half-orc</span></label>
        
        <input id="dndrace8" type="radio" name="race_class_buttons" value="Halfling" <?php checked( $racevalue, 'Halfling' ); ?>>
        <label for="dndrace8"><img src="<?php echo plugins_url('images/256x256.png', dirname(__FILE__)); ?>"><span>Halfling</span></label>
        
        <input id="dndrace9" type="radio" name="race_class_buttons" value="Human" <?php checked( $racevalue, 'Human' ); ?>>
        <label for="dndrace9"><img src="<?php echo plugins_url('images/256x256.png', dirname(__FILE__)); ?>"><span>Human</span></label>
        
        <input id="dndrace10" type="radio" name="race_class_buttons" value="Tiefling" <?php checked( $racevalue, 'Tiefling' ); ?>>
        <label for="dndrace10"><img src="<?php echo plugins_url('images/256x256.png', dirname(__FILE__)); ?>"><span>Tiefling</span></label>
